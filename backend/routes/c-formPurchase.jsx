...
export default function CFormPurchase() {
  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50">
      <div className="p-4 bg-white border-b flex justify-between items-center">
        <h3 className="font-bold uppercase text-sm text-slate-800">C Form Purchase Register</h3>
        <button onClick={() => setIsModalOpen(true)} className="bg-blue-600 text-white px-4 py-2 rounded text-xs font-bold flex items-center gap-1"><Plus className="w-4 h-4"/> Add C Form</button>
      </div>
        ...
        <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl flex flex-col max-h-[90vh]">
            <div className="p-4 border-b flex justify-between items-center bg-slate-50">
              <h3 className="font-bold uppercase text-sm">C Form Purchase Entry</h3>
            ...
            <div className="p-6 overflow-auto flex-1 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4 border-t pt-4 text-xs font-bold text-slate-700">
                ...
                <div className="flex flex-col"><label>Total</label><input readOnly className="p-2 border rounded bg-slate-50 font-mono text-right text-blue-600" /></div>
              </div>
            </div>
