  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50">
      <div className="p-4 bg-white border-b flex justify-between items-center">
        <h3 className="font-bold uppercase text-sm text-slate-800">H Form Register</h3>
        <button onClick={() => setIsModalOpen(true)} className="bg-blue-600 text-white px-4 py-2 rounded text-xs font-bold flex items-center gap-1"><Plus className="w-4 h-4"/> Add H Form</button>
      </div>
      <div className="p-6 flex-1 text-center text-slate-400 text-sm mt-10">Click Add H Form to begin.</div>

      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl flex flex-col max-h-[90vh]">
            <div className="p-4 border-b flex justify-between items-center bg-slate-50">
              <h3 className="font-bold uppercase text-sm">H Form Entry</h3>
            ...
            <div className="p-6 overflow-auto flex-1 flex flex-col gap-6">
              <div className="grid grid-cols-4 gap-4 text-xs font-semibold text-slate-700">
                ...
                <div className="flex flex-col"><label>H FORM No.</label><input type="text" className="p-2 border rounded" /></div>
                <div className="flex flex-col"><label>Received Date</label><input type="date" className="p-2 border rounded" /></div>
                <div className="flex flex-col"><label>H FORM Amount</label><input type="number" className="p-2 border rounded font-mono" /></div>
                <div className="flex flex-col"><label>BL No.</label><input type="text" className="p-2 border rounded" /></div>
                <div className="flex flex-col"><label>Remarks</label><input type="text" className="p-2 border rounded" /></div>
              </div>
